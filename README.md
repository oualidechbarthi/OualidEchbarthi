# Salut, je suis Oualid Echbarthi 👋
...
## 🚀 À propos de moi
Passionné par le Cloud, l'IA et les réseaux. J'ai travaillé sur le déploiement
de modèles LLM sur Azure lors de mon stage chez MX4.AI à Rabat.
...
|--------|------|-------------|
| 🏫 Gestion Scolaire | C++ | Application POO de gestion d'établissement scolaire |
